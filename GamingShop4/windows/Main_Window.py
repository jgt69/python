...
class VentanaTienda(object):
    def setupUi(self, VentanaTienda):
        ...
        VentanaTienda.setGeometry(500, 150, 600, 620)
        VentanaTienda.setWindowIcon(QIcon('./icon/anonymous.png'))
        self.centralwidget = QtWidgets.QWidget(VentanaTienda)
        self.centralwidget.setObjectName("centralwidget")
        self.lbl_mi_tienda = QtWidgets.QLabel(self.centralwidget)
        self.lbl_mi_tienda.setGeometry(QtCore.QRect(90, 10, 380, 80))
        font = QtGui.QFont()
        ...
        self.lbl_logo.setGeometry(QtCore.QRect(40, 90, 500, 450))
